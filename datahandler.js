...
const dataFile = "foldingpaper.json";
const dataFilePath = join(import.meta.dirname, dataFile);
let foldingPaper = JSON.parse(fs.readFileSync(dataFilePath, "utf8"));
...
function getFoldingPaper() {
	return cloneObj(foldingPaper);
}

function saveState(data) {
	foldingPaper = cloneObj(data);
